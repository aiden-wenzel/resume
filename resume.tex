...
\begin{itemize}
	...
	\item Implemented optimization algorithm to approximate the B1 magnetic field maps inside MRI scanner with Julia.
\end{itemize}

\position[Instructional Aide]{ENGR 101 Instructor}{Sep 2026}{Present}
\begin{itemize}
	\item Taught introductory programming lab to incoming engineering students.
	\item Answered student questions through in-person office hours and forum styled posts.
\end{itemize}
...
\begin{itemize}
	...
	\item Utilized the Discrete Cosine Transform, Singular Value Decomposition, and Huffman Encoding to compress images.
\end{itemize}
...
\begin{itemize}
	\item Utilized the MLX90640 IR array sensor and ESP32 to track the movement of heat signatures in and out of a room.
	\item Worked extensively with the MLX90640 API, contour tracing algorithms, and Wi-Fi communication.
	\item Designed custom PCB to interface MLX with the ESP32.
\end{itemize}
...
\begin{itemize}
	\item \class{Digital Signal Processing} Studied mathematical concepts such as LTI systems, convolution, FFT, and the Z-transform in the discrete domain. Utilized languages like MATLAB and Python to quickly perform calculations on vectors and matrices. Explored the applications of signal processing in communications, music, image processing, and medicine. 
	\item \class{Mathematics for Machine Learning} Utilized linear algebra and multi-variable calculus to derive important machine learning equations. Homeworks involved using Python to implement algorithms learned in class.
\end{itemize}
