...
\begin{itemize}
	...
	\item \class{Digital Logic Design} Boolean algebra, switching functions, adders, latches, flip flops, logic minimization, clocks, counters, RTL design, sequential and combinational timing, two level logic minimization, state minimization.
\end{itemize}
