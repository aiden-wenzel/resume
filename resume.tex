...
\begin{itemize}
	\item \class{Data Structures and Algorithms} Stacks, queues, complexity analysis, profiling tools, valgrind, recursion, STL, trees, heaps, sets, hashing, hashmaps, directed and undirected graphs, traveling sales person problem, dynamic programming.
